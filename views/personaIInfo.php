        ...
        <nav class="navbar bg-body-tertiary ">
            <div class="container-fluid d-flex align-content-center">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu mt-4" style="width: 12rem;">
                        <li class="py-2"><a class="dropdown-item d-flex gap-3 my-profile" href="#"><i
                                    class="bi bi-person-circle"></i> <span>My
                                    Profile</span></a></li>
                        <li class="py-2"><a class="dropdown-item d-flex gap-3" href="#"> <i
