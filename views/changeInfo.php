...
<head>
    ...
    <script src="../scripts_js/validacion_changeInfo.js"></script>
    <script src="../scripts_js/previsualizacionImg.js"></script>
...
<body>
            ...
            <div class="container-fluid d-flex align-content-center">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu mt-4 dropdown-list">
                        <li class="py-2 dropdown-li"><a class="dropdown-item d-flex gap-3 item-profile" href="#"><i class="bi bi-person-circle"></i> <span>My
                                    Profile</span></a></li>
                        <li class="py-2 dropdown-li"><a class="dropdown-item d-flex gap-3 item-profile" href="#"> <i class="bi bi-people-fill"></i>
                                <span>Group
                                    Chat</span></a></li>
                        <li class="line"></li>
    ...
    <main class="d-flex flex-column ">
        ...
        <form action="/scripts_php/update_usuario.php" method="post" enctype="multipart/form-data" onsubmit="return validarFormulario()">
            ...
            <div class="card my-4 mx-auto px-5 py-4 card-with">
                ...
                foreach ($data as $usuario) { ?>
                    <div class="d-flex align-items-center">
                        ...
                        if ($usuario["photo"] !== null) {
                            $img_blog = base64_encode($usuario["photo"]); ?>
                            <img id="preview" src='data:image/*;base64,<?= $img_blog ?>' alt="avatar usuario" class="avatar-img">
                        <?php } else { ?>
